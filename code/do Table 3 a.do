...
log using "log Table 3 a.smcl", replace

***************************************************************************
* This is "do Table 3 a.do"
...
** Table 3 Part 1: DALYs, Age-standardized
* Input data: "IHME-GBD_2019_DATA-41.csv"
* Output data: "Table 3 Part1.dta"

** Table 3 Part 2: DALYs, Age: <5, 5-14, 15-49, 50-69, 70+
