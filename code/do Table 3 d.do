...
log using "log Table 3 d.smcl", replace

***************************************************************************
* This is "do Table 3 d.do"
...
** Prepares Table 3, Life expectancy
...
** Table 3 Part 7: YLDs, Life expectancy
* Input data: "IHME-GBD_2019_DATA-47.csv"
* Output data: "Table 3 Part7.dta"
...
save "Table 3 Part7.dta", replace


/* "Table 3 Part7.dta" contents
